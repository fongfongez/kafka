...
# 基本參數
KAFKA_BROKER_URL = '3.133.129.65:9092'  # 設定要連接的Kafka群
WORKSHOP_ID = 'tjr101'  # 修改成你/妳的班級編號
STUDENT_ID = int("100")  # 修改成你/妳的學生編號
...
if __name__ == '__main__':
    ...
    try:
        ...
        producer.produce(topicName, '4', STUDENT_ID + '|01')  # 第 1題
        ...
        producer.produce(topicName, '1', STUDENT_ID + '|05')  # 第 5題
        ...
        producer.produce(topicName, '1', STUDENT_ID + '|11')  # 第11題
